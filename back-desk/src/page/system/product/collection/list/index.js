    ...
    class SystemUserPersonList extends React.Component {
      state = {
        columns: [
          ...
          {
            title: '预览图', dataIndex: 'previewImage', render: (text, record) => (
      ...
      refreshData = async () => {
        ...
        // 获取表格数据
        // await api.collection.selectPersonList({
            ...
            records: [
              {
                id: 1,
                name: "赵春翔",
                previewImage: "http://www.cguardian.com.hk/upload/image/127/s/0001.jpg",
              ...
              },
              {
                id: 3,
                name: "赵春翔",
                previewImage: "http://www.cguardian.com.hk/upload/image/127/s/0003.jpg",
                createdAt: "2018-12-02 15:37:00",
                updatedAt: "2018-12-11 18:49:11"
              }
            ],
      ...
      deleteData = (record) => {
        Modal.confirm({
          ...
          onOk: async () => {
            ...
            // await api.collection.deletePersonById(record.id);
            // 刷新表格数据
            this.refreshData();
          },
          onCancel() {
